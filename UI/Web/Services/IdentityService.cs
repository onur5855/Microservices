...
namespace Web.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<ResponseDto<bool>> SignIn(SignInInput signInInput)
        {
            ...
            var userınfo=await _httpClient.GetUserInfoAsync(userInfoRequest);
            if (userınfo.IsError)
            {
                throw userınfo.Exception;
            }

            ClaimsIdentity claimsIdentity = new ClaimsIdentity(userınfo.Claims,
